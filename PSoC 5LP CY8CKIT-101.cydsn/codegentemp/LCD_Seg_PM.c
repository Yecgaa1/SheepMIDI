...
void LCD_Seg_SaveConfig(void) 
{
    ...
    #ifdef LCD_Seg_SAVE_CONFIG_CALLBACK
        LCD_Seg_SaveConfig_Callback();
    #endif /* LCD_Seg_SAVE_CONFIG_CALLBACK */
}
...
void LCD_Seg_RestoreConfig(void) 
{
    ...
    #ifdef LCD_Seg_RESTORE_CONFIG_CALLBACK
        LCD_Seg_RestoreConfig_Callback();
    #endif /* LCD_Seg_RESTORE_CONFIG_CALLBACK */
}
