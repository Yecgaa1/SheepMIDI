...
# Date: Thu, 09 Jan 2025 06:24:19 GMT
#set_units -time ns
create_clock -name {WaveDAC8_DacClk(routed)} -period 124999.99999999997 -waveform {0 62500} [list [get_pins {ClockBlock/dclk_2}]]
create_clock -name {Clock_500Hz(routed)} -period 2000000 -waveform {0 1000000} [list [get_pins {ClockBlock/dclk_7}]]
...
create_generated_clock -name {Clk_Tmr_CH3} -source [get_pins {ClockBlock/clk_sync}] -edges {1 36001 72001} -nominal_period 999999.99999999977 [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clk_Tmr_CH2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 36001 72001} -nominal_period 999999.99999999977 [list [get_pins {ClockBlock/dclk_glb_4}]]
create_generated_clock -name {Clk_Tmr_CH1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 36001 72001} -nominal_period 999999.99999999977 [list [get_pins {ClockBlock/dclk_glb_5}]]
create_generated_clock -name {Clk_Tmr_Button} -source [get_pins {ClockBlock/clk_sync}] -edges {1 36001 72001} -nominal_period 999999.99999999977 [list [get_pins {ClockBlock/dclk_glb_6}]]
create_generated_clock -name {Clock_500Hz} -source [get_pins {ClockBlock/clk_sync}] -edges {1 72001 144001} [list [get_pins {ClockBlock/dclk_glb_7}]]


# Component constraints for G:\SheepMIDI\PSoC 5LP CY8CKIT-101.cydsn\TopDesign\TopDesign.cysch
# Project: G:\SheepMIDI\PSoC 5LP CY8CKIT-101.cydsn\PSoC 5LP CY8CKIT-101.cyprj
# Date: Thu, 09 Jan 2025 06:24:12 GMT
