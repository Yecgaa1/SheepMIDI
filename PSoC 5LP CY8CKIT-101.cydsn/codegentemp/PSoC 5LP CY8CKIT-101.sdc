...
# Date: Wed, 08 Jan 2025 06:55:57 GMT
#set_units -time ns
create_clock -name {WaveDAC8_DacClk(routed)} -period 124999.99999999997 -waveform {0 62500} [list [get_pins {ClockBlock/dclk_2}]]
create_clock -name {Clock_500Hz(routed)} -period 2000000 -waveform {0 1000000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clk_Tmr_Button} -source [get_pins {ClockBlock/clk_sync}] -edges {1 36001 72001} -nominal_period 999999.99999999977 [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clock_500Hz} -source [get_pins {ClockBlock/clk_sync}] -edges {1 72001 144001} [list [get_pins {ClockBlock/dclk_glb_4}]]


# Component constraints for G:\SheepMIDI\PSoC 5LP CY8CKIT-101.cydsn\TopDesign\TopDesign.cysch
# Project: G:\SheepMIDI\PSoC 5LP CY8CKIT-101.cydsn\PSoC 5LP CY8CKIT-101.cyprj
# Date: Wed, 08 Jan 2025 06:55:51 GMT
