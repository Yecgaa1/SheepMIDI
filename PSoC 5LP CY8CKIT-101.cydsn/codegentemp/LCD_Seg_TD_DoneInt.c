...
{
    #ifdef LCD_Seg_TD_DoneInt_INTERRUPT_INTERRUPT_CALLBACK
        LCD_Seg_TD_DoneInt_Interrupt_InterruptCallback();
    #endif /* LCD_Seg_TD_DoneInt_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling LCD_Seg_TD_DoneInt_Start or LCD_Seg_TD_DoneInt_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after LCD_Seg_TD_DoneInt_Start or LCD_Seg_TD_DoneInt_StartEx has been called. 
