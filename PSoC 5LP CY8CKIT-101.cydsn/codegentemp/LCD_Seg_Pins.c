...
void LCD_Seg_SegPort_SetDriveMode(uint8 mode) 
{
    ...
    CyPins_SetPinDriveMode(LCD_Seg_SegPort_8, mode);
    CyPins_SetPinDriveMode(LCD_Seg_SegPort_9, mode);
}
...
void LCD_Seg_ComPort_SetDriveMode(uint8 mode) 
{
    ...
    CyPins_SetPinDriveMode(LCD_Seg_ComPort_1, mode);
    CyPins_SetPinDriveMode(LCD_Seg_ComPort_2, mode);
    CyPins_SetPinDriveMode(LCD_Seg_ComPort_3, mode);
}
