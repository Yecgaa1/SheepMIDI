...
#define LCD_Seg_SegPort_8            LCD_Seg_Seg__8__PC
#define LCD_Seg_SegPort_9            LCD_Seg_Seg__9__PC
#define LCD_Seg_ComPort_0            LCD_Seg_Com__0__PC
#define LCD_Seg_ComPort_1            LCD_Seg_Com__1__PC
#define LCD_Seg_ComPort_2            LCD_Seg_Com__2__PC
#define LCD_Seg_ComPort_3            LCD_Seg_Com__3__PC
