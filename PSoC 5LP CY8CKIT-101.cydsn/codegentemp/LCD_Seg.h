...
#define LCD_Seg_DIGIT_NUM_0            (5u)
#define LCD_Seg_DIGIT_NUM_1            (5u)

#define LCD_Seg_COM0_PORT            LCD_Seg_Com__LCD_COM_PORT__0
#define LCD_Seg_COM0_PIN            LCD_Seg_Com__LCD_COM_PIN__0
#define LCD_Seg_COM1_PORT            LCD_Seg_Com__LCD_COM_PORT__1
#define LCD_Seg_COM1_PIN            LCD_Seg_Com__LCD_COM_PIN__1
#define LCD_Seg_COM2_PORT            LCD_Seg_Com__LCD_COM_PORT__2
#define LCD_Seg_COM2_PIN            LCD_Seg_Com__LCD_COM_PIN__2
#define LCD_Seg_COM3_PORT            LCD_Seg_Com__LCD_COM_PORT__3
#define LCD_Seg_COM3_PIN            LCD_Seg_Com__LCD_COM_PIN__3

#define LCD_Seg_Com0            LCD_Seg_FIND_PIXEL(LCD_Seg_COM0_PORT,  LCD_Seg_COM0_PIN,  0)
#define LCD_Seg_Com1            LCD_Seg_FIND_PIXEL(LCD_Seg_COM1_PORT,  LCD_Seg_COM1_PIN,  1)
#define LCD_Seg_Com2            LCD_Seg_FIND_PIXEL(LCD_Seg_COM2_PORT,  LCD_Seg_COM2_PIN,  2)
#define LCD_Seg_Com3            LCD_Seg_FIND_PIXEL(LCD_Seg_COM3_PORT,  LCD_Seg_COM3_PIN,  3)
...
#define LCD_Seg_SEG8_PORT            LCD_Seg_Seg__LCD_SEG_PORT__8
#define LCD_Seg_SEG8_PIN            LCD_Seg_Seg__LCD_SEG_PIN__8
#define LCD_Seg_SEG9_PORT            LCD_Seg_Seg__LCD_SEG_PORT__9
#define LCD_Seg_SEG9_PIN            LCD_Seg_Seg__LCD_SEG_PIN__9

#define LCD_Seg_A1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG1_PORT,  LCD_Seg_SEG1_PIN,  0)
#define LCD_Seg_B1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG1_PORT,  LCD_Seg_SEG1_PIN,  1)
#define LCD_Seg_C1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG1_PORT,  LCD_Seg_SEG1_PIN,  2)
#define LCD_Seg_D1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG0_PORT,  LCD_Seg_SEG0_PIN,  3)
#define LCD_Seg_E1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG0_PORT,  LCD_Seg_SEG0_PIN,  2)
#define LCD_Seg_F1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG0_PORT,  LCD_Seg_SEG0_PIN,  0)
#define LCD_Seg_G1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG0_PORT,  LCD_Seg_SEG0_PIN,  1)
#define LCD_Seg_A2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG3_PORT,  LCD_Seg_SEG3_PIN,  0)
#define LCD_Seg_B2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG3_PORT,  LCD_Seg_SEG3_PIN,  1)
#define LCD_Seg_C2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG3_PORT,  LCD_Seg_SEG3_PIN,  2)
#define LCD_Seg_D2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG2_PORT,  LCD_Seg_SEG2_PIN,  3)
#define LCD_Seg_E2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG2_PORT,  LCD_Seg_SEG2_PIN,  2)
#define LCD_Seg_F2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG2_PORT,  LCD_Seg_SEG2_PIN,  0)
#define LCD_Seg_G2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG2_PORT,  LCD_Seg_SEG2_PIN,  1)
#define LCD_Seg_A3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG5_PORT,  LCD_Seg_SEG5_PIN,  0)
#define LCD_Seg_B3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG5_PORT,  LCD_Seg_SEG5_PIN,  1)
#define LCD_Seg_C3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG5_PORT,  LCD_Seg_SEG5_PIN,  2)
#define LCD_Seg_D3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG4_PORT,  LCD_Seg_SEG4_PIN,  3)
#define LCD_Seg_E3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG4_PORT,  LCD_Seg_SEG4_PIN,  2)
#define LCD_Seg_F3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG4_PORT,  LCD_Seg_SEG4_PIN,  0)
#define LCD_Seg_G3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG4_PORT,  LCD_Seg_SEG4_PIN,  1)
#define LCD_Seg_A4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG7_PORT,  LCD_Seg_SEG7_PIN,  0)
#define LCD_Seg_B4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG7_PORT,  LCD_Seg_SEG7_PIN,  1)
#define LCD_Seg_C4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG7_PORT,  LCD_Seg_SEG7_PIN,  2)
#define LCD_Seg_D4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG6_PORT,  LCD_Seg_SEG6_PIN,  3)
#define LCD_Seg_E4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG6_PORT,  LCD_Seg_SEG6_PIN,  2)
#define LCD_Seg_F4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG6_PORT,  LCD_Seg_SEG6_PIN,  0)
#define LCD_Seg_G4            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG6_PORT,  LCD_Seg_SEG6_PIN,  1)
#define LCD_Seg_A5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG9_PORT,  LCD_Seg_SEG9_PIN,  0)
#define LCD_Seg_B5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG9_PORT,  LCD_Seg_SEG9_PIN,  1)
#define LCD_Seg_C5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG9_PORT,  LCD_Seg_SEG9_PIN,  2)
#define LCD_Seg_D5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG8_PORT,  LCD_Seg_SEG8_PIN,  3)
#define LCD_Seg_E5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG8_PORT,  LCD_Seg_SEG8_PIN,  2)
#define LCD_Seg_F5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG8_PORT,  LCD_Seg_SEG8_PIN,  0)
#define LCD_Seg_G5            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG8_PORT,  LCD_Seg_SEG8_PIN,  1)
#define LCD_Seg_T1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG3_PORT,  LCD_Seg_SEG3_PIN,  3)
#define LCD_Seg_T2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG1_PORT,  LCD_Seg_SEG1_PIN,  3)
#define LCD_Seg_P1            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG5_PORT,  LCD_Seg_SEG5_PIN,  3)
#define LCD_Seg_P2            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG7_PORT,  LCD_Seg_SEG7_PIN,  3)
#define LCD_Seg_P3            LCD_Seg_FIND_PIXEL(LCD_Seg_SEG9_PORT,  LCD_Seg_SEG9_PIN,  3)


#define LCD_Seg_NOT_CON            (0xFFFFu)
#define LCD_Seg_SegLcdPort_DMA_TD_PROTO_COUNT 2
...
#define LCD_Seg_SEG_NUM               (10u)
#define LCD_Seg_BIAS_TYPE             (0u)
#define LCD_Seg_BIAS_VOLTAGE          (63u)
#define LCD_Seg_POWER_MODE            (0u)
#define LCD_Seg_FRAME_RATE            (30u)
#define LCD_Seg_HI_DRIVE_TIME         (2u)
#define LCD_Seg_LOW_DRIVE_TIME        (252u)
#define LCD_Seg_HIDRIVE_STRENGTH      (4u)
...
#define LCD_Seg_LCDDRV_BYPASS_EN          (0x10u)
    ...
    #define LCD_Seg_TIMER_PERIOD              (13u)
