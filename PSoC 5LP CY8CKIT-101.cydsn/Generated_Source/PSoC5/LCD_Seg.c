...
static uint16 LCD_Seg_commons[4u] = {LCD_Seg_Com0, LCD_Seg_Com1, LCD_Seg_Com2, LCD_Seg_Com3};
...
static uint8 LCD_Seg_DmaConfigure(void) CYREENTRANT
{
    ...
    uint32  dstAddr;
    /* DMA_PROTO_TD_DEF */
    static const struct LCD_Seg_DMA_TD_PROTO_ENTRY CYCODE LCD_Seg_SegLcdPort_DMA_TD_PROTO_BLOCK[2u] =
    {
        {0u, 1u},
        {3u, 2u},
    };
...
{
    static const uint16 CYCODE LCD_Seg_disp0[5u][7u] = {{LCD_Seg_A1, LCD_Seg_B1, LCD_Seg_C1, LCD_Seg_D1, LCD_Seg_E1,
    LCD_Seg_F1, LCD_Seg_G1}, {LCD_Seg_A2, LCD_Seg_B2, LCD_Seg_C2, LCD_Seg_D2, LCD_Seg_E2, LCD_Seg_F2, LCD_Seg_G2},
    {LCD_Seg_A3, LCD_Seg_B3, LCD_Seg_C3, LCD_Seg_D3, LCD_Seg_E3, LCD_Seg_F3, LCD_Seg_G3}, {LCD_Seg_A4, LCD_Seg_B4,
    LCD_Seg_C4, LCD_Seg_D4, LCD_Seg_E4, LCD_Seg_F4, LCD_Seg_G4}, {LCD_Seg_A5, LCD_Seg_B5, LCD_Seg_C5, LCD_Seg_D5,
    LCD_Seg_E5, LCD_Seg_F5, LCD_Seg_G5}};
    uint8 i;
...
{
    static const uint16 CYCODE LCD_Seg_disp1[6u][1u] = {{0u}, {LCD_Seg_T1}, {LCD_Seg_T2}, {LCD_Seg_P1}, {LCD_Seg_P2},
    {LCD_Seg_P3}};
    uint16 i;
    uint16 maxValue = 5u;
