...
#define LCD_Seg_Int_Clock_SetDivider(clkDivider)         LCD_Seg_Int_Clock_SetDividerRegister(clkDivider, 1u)
#define LCD_Seg_Int_Clock_SetDividerValue(clkDivider)    LCD_Seg_Int_Clock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define LCD_Seg_Int_Clock_SetPhaseValue(clkPhase)        LCD_Seg_Int_Clock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(LCD_Seg_Int_Clock__CFG3) */
