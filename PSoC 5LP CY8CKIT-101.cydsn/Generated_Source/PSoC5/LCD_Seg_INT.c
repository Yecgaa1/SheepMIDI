...
CY_ISR(LCD_Seg_ISR)
{
    #ifdef LCD_Seg_ISR_INTERRUPT_CALLBACK
        LCD_Seg_ISR_InterruptCallback();
    #endif /* LCD_Seg_ISR_INTERRUPT_CALLBACK */
...
{
    #ifdef LCD_Seg_WAKEUP_ISR_INTERRUPT_CALLBACK
        LCD_Seg_WAKEUP_ISR_InterruptCallback();
    #endif /* LCD_Seg_WAKEUP_ISR_INTERRUPT_CALLBACK */
