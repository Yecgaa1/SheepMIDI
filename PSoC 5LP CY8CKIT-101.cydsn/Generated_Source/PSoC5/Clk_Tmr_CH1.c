...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_Start(void) 
{
    /* Set the bit to enable the clock. */
    Clk_Tmr_CH1_CLKEN |= Clk_Tmr_CH1_CLKEN_MASK;
	Clk_Tmr_CH1_CLKSTBY |= Clk_Tmr_CH1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    Clk_Tmr_CH1_CLKEN &= (uint8)(~Clk_Tmr_CH1_CLKEN_MASK);
	Clk_Tmr_CH1_CLKSTBY &= (uint8)(~Clk_Tmr_CH1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_StopBlock(void) 
{
    if ((Clk_Tmr_CH1_CLKEN & Clk_Tmr_CH1_CLKEN_MASK) != 0u)
    {
...
#if defined(Clk_Tmr_CH1__CFG3)
        CLK_DIST_AMASK = Clk_Tmr_CH1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clk_Tmr_CH1_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clk_Tmr_CH1__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clk_Tmr_CH1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clk_Tmr_CH1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Clk_Tmr_CH1_CLKSTBY &= (uint8)(~Clk_Tmr_CH1_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clk_Tmr_CH1_GetSourceRegister();
    uint16 oldDivider = Clk_Tmr_CH1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clk_Tmr_CH1_CLKEN & Clk_Tmr_CH1_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clk_Tmr_CH1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 Clk_Tmr_CH1_GetDividerRegister(void) 
{
    return CY_GET_REG16(Clk_Tmr_CH1_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_SetModeRegister(uint8 modeBitMask) 
{
    Clk_Tmr_CH1_MOD_SRC |= modeBitMask & (uint8)Clk_Tmr_CH1_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_ClearModeRegister(uint8 modeBitMask) 
{
    Clk_Tmr_CH1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clk_Tmr_CH1_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clk_Tmr_CH1_GetModeRegister(void) 
{
    return Clk_Tmr_CH1_MOD_SRC & (uint8)(Clk_Tmr_CH1_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Clk_Tmr_CH1_GetDividerRegister();
    uint8 oldSrc = Clk_Tmr_CH1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clk_Tmr_CH1_MOD_SRC |= CYCLK_SSS;
        Clk_Tmr_CH1_MOD_SRC =
            (Clk_Tmr_CH1_MOD_SRC & (uint8)(~Clk_Tmr_CH1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clk_Tmr_CH1_GetSourceRegister(void) 
{
    return Clk_Tmr_CH1_MOD_SRC & Clk_Tmr_CH1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clk_Tmr_CH1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clk_Tmr_CH1_SetPhaseRegister(uint8 clkPhase) 
{
    Clk_Tmr_CH1_PHASE = clkPhase & Clk_Tmr_CH1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clk_Tmr_CH1_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clk_Tmr_CH1_GetPhaseRegister(void) 
{
    return Clk_Tmr_CH1_PHASE & Clk_Tmr_CH1_PHASE_MASK;
}
